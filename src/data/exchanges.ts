...
export const exchanges: Exchange[] = [
  ...
  },
  {
    ...
    logoColor: "#0052FF",
    description:
      "米国ナスダック上場・世界有数のコインベースの日本法人。金融庁登録済みで透明性が高く、セキュリティ実績も優秀。シンプルなUIで初心者にも使いやすい。",
    tokens: [
      "BTC",
      "ETH",
      "XRP",
    ...
    trustScore: 5,
    notes:
      "重大なセキュリティ事故なし。米ナスダック上場企業の日本法人で透明性・信頼性がトップクラス。",
    affiliateUrl: "",
    affiliateType: "referral",
    affiliateNote: "公式リファラルプログラムで発行可能",
    tokensUrl: "https://www.coinbase.com/ja/markets",
  },
];
